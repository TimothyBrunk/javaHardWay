...
public class DictionaryOrder {
	public static void main( String[] args ) {
		...
		System.out.print( "Make up the name of the programming language! ");
		...
		if ( name.compareTo("lisp") < 0 ) 
			System.out.print( name + " comes BEFORE lisp" );
		if ( name.compareTo("lisp") == 0 )
			System.out.print( " lisp isn't a made-up language!" );
		if ( name.compareTo("lisp") > 0 )
		...
		if ( name.compareTo("visualbasic") == 0 ) 
			System.out.println( " visualbasic isn't a made-up langue!" );
		if ( name.compareTo("visualbasic") > 0 )
